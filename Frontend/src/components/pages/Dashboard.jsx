            ...
            <div className="flex flex-wrap sm:flex-nowrap justify-between items-center mb-4 gap-2">
              ...
              <div className="flex items-center gap-4 flex-wrap justify-end">
                <div className="tabs tabs-bordered">
                  <a
                    className={`tab min-w-[80px] text-sm ${viewMode === "monthly" ? "tab-active" : ""}`}
                    onClick={() => setViewMode("monthly")}
                  >
                    Monthly
                  </a>
                  <a
                    className={`tab min-w-[80px] text-sm ${viewMode === "datewise" ? "tab-active" : ""}`}
  ...
  <div className="relative">
    ...
    >
      ...
      {Array.from({ length: 12 }, (_, index) => {
        ...
        const monthLabel = new Date(`${monthValue}-01`).toLocaleString("default", {
          month: "long",
        });
        return (
